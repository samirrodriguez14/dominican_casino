...
/// Center congrats card, then coins jump into the top-right stack.
class HomeCoinCelebrationOverlay extends StatefulWidget {
  const HomeCoinCelebrationOverlay({
    super.key,
  ...
  @override
  State<HomeCoinCelebrationOverlay> createState() =>
      _HomeCoinCelebrationOverlayState();
}

class _HomeCoinCelebrationOverlayState extends State<HomeCoinCelebrationOverlay>
            ...
            child: ScaleTransition(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      l10n.coinsCongratsTitle,
                      textAlign: TextAlign.center,
                      style: theme.title.copyWith(fontSize: 22),
                    ),
                    const SizedBox(height: 8),
                    Text(
                      l10n.coinsCongratsBody(widget.amount),
                      textAlign: TextAlign.center,
                      style: theme.body,
                    ),
